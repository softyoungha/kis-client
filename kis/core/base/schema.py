...
class ResponseData(GenericModel, Generic[Data]):
    ...
    fk100: Optional[str] = Field("", alias="ctx_area_fk100", title="연속조회검색조건100", repr=False)
    nk100: Optional[str] = Field("", alias="ctx_area_nk100", title="연속조회키100", repr=False)
    fk200: Optional[str] = Field("", alias="ctx_area_fk200", title="연속조회검색조건200", repr=False)
    nk200: Optional[str] = Field("", alias="ctx_area_nk200", title="연속조회키200", repr=False)
